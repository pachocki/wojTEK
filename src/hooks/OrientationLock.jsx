...
const OrientationLock = () => {
  ...
  return !isPortrait ? <div className="w-full h-screen overflow-hidden bg-black z-[9999] fixed flex justify-center items-center text-5xl"><h1>This site works only in portrait</h1></div> : null;
};
